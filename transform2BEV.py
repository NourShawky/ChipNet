...
# parse parameters
dataFiles = "KITTI_road/training/image_2/*.png"#sys.argv[1]
pathToCalib = "KITTI_road/training/calib" #sys.argv[2]
outputPath = "KITTI_road/training/gt_road_BEV"#sys.argv[3]
